      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Add a new bank account to your financial system
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Link this bank account to your chart of accounts
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base font-medium">
                  Automatically create Chart of Accounts entry
                </h3>
                <p className="text-sm text-muted-foreground">
                  This will create a corresponding account in your Chart of
                  Accounts
                </p>
              </div>
              <div className="flex items-center space-x-2">
            ...
            {createCOA && (
              <div className="p-4 bg-muted rounded-md space-y-6">
                <Alert>
                  ...
                  <AlertDescription>
                    This will create a new account in your Chart of Accounts
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Bank accounts are always assets
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Select value={coaSubtype} onValueChange={setCoaSubtype}>
                      ...
                      <SelectContent>
                        <SelectItem value="Current Asset">
                          Current Asset
                        </SelectItem>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide more information about this account
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-3">
